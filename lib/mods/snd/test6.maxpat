...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 279.25, 1264.0, 34.0, 22.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 238.833333333333314, 1195.0, 33.0, 58.0 ],
					"varname" : "df.bgain[5]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 179.833333333333314, 1182.0, 33.0, 58.0 ],
					"varname" : "df.bgain[4]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 227.0, 1275.0, 34.0, 22.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 380.0, 1141.0, 50.0, 22.0 ],
					"varname" : "number[7]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 123.5, 921.0, 24.0, 24.0 ],
					"varname" : "button[3]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 94.0, 998.0, 29.5, 22.0 ],
					"text" : "0, 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 102.0, 1093.0, 24.0, 24.0 ],
					"varname" : "toggle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 1141.0, 59.0, 22.0 ],
					"text" : "freeze $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 367.349099089702008, 1088.0, 50.0, 22.0 ],
					"varname" : "number[6]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.349099089702008, 1088.0, 50.0, 22.0 ],
					"varname" : "number[5]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 292.349099089702008, 1116.0, 50.0, 22.0 ],
					"varname" : "number[4]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 244.0, 1098.0, 50.0, 22.0 ],
					"varname" : "number[3]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 340.0, 1112.0, 50.0, 22.0 ],
					"varname" : "number[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 250.0, 1160.0, 92.5, 22.0 ],
					"text" : "th.yafr.freeze~"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 195.333333333333258, 941.5, 346.0, 146.0 ],
					"varname" : "df.beq",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 424.333333333333258, 710.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.599099089702008, 1366.0, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 600.349099089702008, 247.0, 36.0, 22.0 ],
					"text" : "+~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 499.333333333333258, 1269.0, 42.0, 22.0 ],
					"text" : "out~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 362.349099089702008, 1269.0, 42.0, 22.0 ],
					"text" : "out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"Glide" : [ 7620.13744499929544 ],
						"Transp" : [ -1379.527559055118218 ],
						"button" : [ 1.0 ],
						"button[1]" : [ 1.0 ],
						"button[2]" : [ 1.0 ],
						"button[3]" : [ 1.0 ],
						"number" : [ 3517.0 ],
						"number[1]" : [ -1341.897621604514143 ],
						"number[2]" : [ 0.6 ],
						"number[3]" : [ 0.047 ],
						"number[4]" : [ 0.645 ],
						"number[5]" : [ 1.13 ],
