...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.166666666666714, 537.0, 42.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.583333333333343, 537.0, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 324.083333333333371, 62.5, 88.0, 22.0 ],
					"text" : "r~ #0_pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1043.583333333333258, 114.0, 90.0, 22.0 ],
					"text" : "s~ #0_pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 878.583333333333371, 185.5, 54.0, 19.0 ],
					"text" : "Envelope"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 872.983333333333462, 114.0, 71.0, 19.0 ],
					"text" : "Domain (ms)"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "df.control~.maxpat",
					"numinlets" : 0,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 843.983333333333348, 135.0, 136.0, 47.0 ],
					"varname" : "df.control~[3]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 807.583333333333371, 306.5, 71.0, 22.0 ],
					"text" : "df.10in 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 807.583333333333371, 206.5, 147.0, 82.0 ],
					"varname" : "dfc.envf",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 145.916666666666686, 101.5, 86.0, 22.0 ],
					"text" : "r~ #0_amp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 807.583333333333371, 342.5, 88.0, 22.0 ],
					"text" : "s~ #0_amp"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 807.583333333333371, 61.666666666666629, 255.0, 44.999999999999972 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 172.583333333333343, 222.0, 68.0, 22.0 ],
					"text" : "df.liner~ 10"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 610.583333333333371, 360.0, 136.0, 47.0 ],
					"varname" : "df.control~[2]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 610.583333333333371, 250.5, 136.0, 47.0 ],
					"varname" : "df.control~[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 610.583333333333371, 75.5, 136.0, 47.0 ],
					"varname" : "df.control~",
					"viewvisibility" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 116.0, 146.0, 150.0, 33.0 ],
									"text" : "makes sure hi and lo notes have the same res"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 26.0, 78.0, 132.0, 22.0 ],
									"text" : "expr \"pow(0.5, in1/in2)\""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 26.0, 120.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 139.0, 38.0, 28.0, 22.0 ],
									"text" : "in 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 26.0, 38.0, 28.0, 22.0 ],
									"text" : "in 1"
								}
...
,
					"patching_rect" : [ 324.083333333333371, 257.5, 136.0, 22.0 ],
					"text" : "gen~ @title #0_expr"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 70.583333333333343, 381.5, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 346.583333333333371, 193.5, 79.0, 22.0 ],
					"text" : "sampstoms~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 346.583333333333371, 161.5, 30.0, 22.0 ],
					"text" : "-~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 346.583333333333371, 130.5, 79.0, 22.0 ],
					"text" : "mstosamps~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 838.583333333333371, 41.666666666666629, 33.0, 19.0 ],
					"text" : "Pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.583333333333343, 190.5, 106.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.083333333333343, 86.5, 65.0, 19.0 ],
					"text" : "Noise Burst"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 611.583333333333371, 445.0, 60.0, 22.0 ],
					"text" : "*~ 22050."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 610.583333333333371, 421.0, 34.0, 22.0 ],
					"text" : "*~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 186.583333333333343, 261.5, 86.0, 22.0 ],
					"text" : "r~ #0_filter"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 611.583333333333371, 471.0, 88.0, 22.0 ],
					"text" : "s~ #0_filter"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 632.583333333333371, 344.0, 65.0, 19.0 ],
					"text" : "Filter Cutoff"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 368.583333333333371, 222.0, 98.0, 22.0 ],
					"text" : "r~ #0_halflife"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 610.583333333333371, 309.5, 100.0, 22.0 ],
					"text" : "s~ #0_halflife"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 642.583333333333371, 229.5, 89.0, 19.0 ],
					"text" : "Resonance (ms)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.583333333333343, 62.5, 118.0, 22.0 ],
					"text" : "r~ #0_brightness"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 610.583333333333371, 194.0, 120.0, 22.0 ],
					"text" : "s~ #0_brightness"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 610.583333333333371, 163.5, 60.0, 22.0 ],
					"text" : "*~ 22050."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 610.583333333333371, 135.0, 34.0, 22.0 ],
					"text" : "*~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 658.583333333333371, 54.5, 60.0, 19.0 ],
					"text" : "Brightness"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 324.083333333333371, 98.5, 56.0, 22.0 ],
					"text" : "!/~ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 250.583333333333343, 296.5, 49.0, 22.0 ],
					"text" : "*~ 0.99"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 115.583333333333343, 296.5, 90.0, 22.0 ],
					"text" : "onepole~ 5000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 115.583333333333343, 266.5, 68.0, 22.0 ],
					"text" : "tapout~ 10"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 115.583333333333343, 206.5, 44.0, 22.0 ],
					"text" : "tapin~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 70.583333333333343, 146.5, 32.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 70.583333333333343, 101.5, 65.0, 22.0 ],
					"text" : "rand~ 600"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 80.083333333333343, 186.0, 125.083333333333343, 186.0 ],
					"order" : 0,
					"source" : [ "obj-351", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 80.083333333333343, 372.5, 109.083333333333343, 372.5 ],
					"order" : 1,
					"source" : [ "obj-351", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 125.083333333333343, 343.5, 229.583333333333343, 343.5, 229.583333333333343, 286.5, 260.083333333333371, 286.5 ],
					"order" : 0,
					"source" : [ "obj-356", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-75", 1 ],
					"midpoints" : [ 125.083333333333343, 349.5, 109.083333333333343, 349.5 ],
					"order" : 1,
					"source" : [ "obj-356", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-75", 0 ],
					"midpoints" : [ 125.083333333333343, 351.0, 80.083333333333343, 351.0 ],
					"order" : 2,
					"source" : [ "obj-356", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-354", 0 ],
					"midpoints" : [ 260.083333333333371, 325.5, 100.583333333333343, 325.5, 100.583333333333343, 196.5, 125.083333333333343, 196.5 ],
					"source" : [ "obj-357", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 196.083333333333343, 291.0, 196.083333333333343, 291.0 ],
					"source" : [ "obj-64", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-136::obj-3" : [ "live.text[5]", "live.text", 0 ],
			"obj-136::obj-318" : [ "function", "function", 0 ],
			"obj-136::obj-321" : [ "number", "number", 0 ],
			"obj-136::obj-48" : [ "live.text[6]", "live.text", 0 ],
			"obj-136::obj-57::obj-11::obj-1" : [ "live.text", "live.text", 0 ],
			"obj-136::obj-59::obj-11::obj-1" : [ "live.text[4]", "live.text", 0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "karplus1.json",
				"bootpath" : "/Volumes/Libraries/Drive/max/df.s2/current/lib/mods/snd/res",
