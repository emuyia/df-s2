...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"Transp" : [ -1833.070866141732267 ],
						"button" : [ 1.0 ],
						"button[1]" : [ 1.0 ],
						"button[2]" : [ 1.0 ],
						"button[3]" : [ 1.0 ],
						"number" : [ 3517.0 ],
						"number[1]" : [ -2231.661712023094879 ],
						"number[2]" : [ 1.36 ],
						"number[3]" : [ 0.928 ],
						"number[4]" : [ 0.645 ],
						"number[5]" : [ 0.93 ],
